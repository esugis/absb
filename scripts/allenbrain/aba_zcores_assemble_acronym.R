# This script assembles matrix of z-scores for all probes in the datasets from individual results for each tissue acronym 
...
load(file = "~/absb/results/allenbrain/all_tissues_acronym.RData" )
